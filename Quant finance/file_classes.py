# -*- coding: utf-8 -*-
"""
Created on Tue Nov 15 11:51:30 2022
...
class hedge_input:
   ...
   def __init__(self):
       ...
       self.security = 'ALUAR.BA' # portfolio to hedge
       self.hedge_securities =  ['^MERV'] # hedge universe
...
class portfolio_manager:
    ...
    def compute_portfolio(self, portfolio_type = 'default', target_return =None):
        ...
        if portfolio_type == 'min-variance':
            ...
            portfolio.variance_explaind = self.eigenvalues[-1] / sum(abs(self.eigenvalues))
